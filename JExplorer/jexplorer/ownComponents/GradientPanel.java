...
public class GradientPanel extends javax.swing.JPanel
{
    ...
    private LinearGradientPaint gp1;
    private Color col1;
    private Color col2;
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(gp1 == null)
        {
            ...
            if(width > 0 && halfHeight > 0.0)
            {
                gp1 = new LinearGradientPaint(new Point2D.Float(0,halfHeight), new Point2D.Float(width, halfHeight), new float[]{0.5f,1.0f}, new Color[]{col1,col2});
            }
        }
        if(gp1 != null)
        {
